      ...
      builder: (context, child) {
        ...
        return Transform(
          ...
          child: Container(
            ...
            padding: EdgeInsets.all(28 + (elasticProgress * 8)),
            decoration: BoxDecoration(
              color: Colors.white.withOpacity(0.08 + (elasticProgress * 0.06)),
              borderRadius: BorderRadius.circular(20 + (elasticProgress * 10)),
              border: Border.all(
                color: const Color(
                  0xFF00FFA3,
                ).withOpacity(0.2 + (elasticProgress * 0.3)),
                width: 1 + (elasticProgress * 1),
              ),
              boxShadow: [
                BoxShadow(
                  color: Colors.black.withOpacity(
                    0.1 + (elasticProgress * 0.15),
                  ),
                  blurRadius: 15 + (elasticProgress * 20),
                  spreadRadius: 0,
                  offset: Offset(0, 6 + (elasticProgress * 8)),
                ),
                BoxShadow(
                  color: const Color(
                    0xFF00FFA3,
                  ).withOpacity(elasticProgress * 0.2),
                  blurRadius: 30,
                  spreadRadius: 0,
                  offset: const Offset(0, 0),
                ),
            ...
            child: Column(
              children: [
                Transform.scale(
                  scale: 0.8 + (elasticProgress * 0.2),
                  child: Container(
                    width: 70 + (elasticProgress * 20),
                    height: 70 + (elasticProgress * 20),
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: const Color(
                            0xFF00FFA3,
                          ).withOpacity(0.3 + (elasticProgress * 0.2)),
                          blurRadius: 15 + (elasticProgress * 10),
                          spreadRadius: 0,
                          offset: Offset(0, 4 + (elasticProgress * 4)),
                        ),
                      ],
                    ),
                    child: Center(
                ...
                SizedBox(height: 24 + (elasticProgress * 8)),
                Transform.rotate(
                  angle: elasticProgress * 0.2,
                  child: Container(
                    padding: EdgeInsets.all(16 + (elasticProgress * 4)),
                    decoration: BoxDecoration(
                      color: const Color(
                        0xFF00FFA3,
                      ).withOpacity(0.1 + (elasticProgress * 0.1)),
                      borderRadius: BorderRadius.circular(
                        16 + (elasticProgress * 4),
                      ),
                      boxShadow: [
                        BoxShadow(
                          color: const Color(
                            0xFF00FFA3,
                          ).withOpacity(elasticProgress * 0.3),
                          blurRadius: 12,
                          spreadRadius: 0,
                        ),
                      ],
                    ...
                    child: Icon(
                      icon,
                      color: const Color(0xFF00FFA3),
                      size: 36 + (elasticProgress * 4),
                    ),
                  ),
                ),
                SizedBox(height: 20 + (elasticProgress * 4)),
                Text(
                  title,
                  style: TextStyle(
                    fontSize: 20 + (elasticProgress * 2),
                    fontWeight: FontWeight.bold,
                    color: Colors.white,
                  ),
                ),
                SizedBox(height: 16 + (elasticProgress * 2)),
                Text(
                  description,
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 14 + (elasticProgress * 1),
                    color: Colors.white.withOpacity(
                      0.7 + (elasticProgress * 0.1),
                    ),
                    height: 1.4,
                  ),
                ),
...
// --- Placeholder Screens (You'll create dedicated files for these next) ---
...
class SignUpScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Center(child: Text('Sign Up Screen Content Will Go Here')),
    );
  }
}
...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Center(child: Text('Login Screen Content Will Go Here')),
    );
  }
}
